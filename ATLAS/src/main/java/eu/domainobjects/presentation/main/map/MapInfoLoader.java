...
import static eu.domainobjects.presentation.main.map.MapInfo.BIKESHARING_POINTS;
import static eu.domainobjects.presentation.main.map.MapInfo.DESTINATION_POINT;
import static eu.domainobjects.presentation.main.map.MapInfo.EXTENT;
import static eu.domainobjects.presentation.main.map.MapInfo.MAX_ZOOM;
import static eu.domainobjects.presentation.main.map.MapInfo.PARKING_POINTS;
import static eu.domainobjects.presentation.main.map.MapInfo.START_LAT;
import static eu.domainobjects.presentation.main.map.MapInfo.START_LON;
import static eu.domainobjects.presentation.main.map.MapInfo.START_ZOOM;
